...
<head>
	...
	<!-- FlexSlider plugin -->
	<link rel="stylesheet" href="<?php echo base_url()?>assets/js/flexslider/flexslider.css" type="text/css" media="screen" />	
		...
		<div class="drop-panel">
			<div class="container">
				<div class="two-thirds column">
					<h3>Plenty of work to go around...</h3>
					<p class="nobottom">
            Do you know HTML5, CSS, PHP and love MVC? Or do you rock the world 
		...
		<div class="drop-bar-container">
			<div class="container">
				<div class="drop-bar sixteen columns far-edge">
					...
					<a href="#" id="drop-panel-expando">We are Hiring!</a>
				</div>
			</div>
		</div>
	</div>
			...
			<nav id="main-nav" class="two-thirds column omega">
				...
				<ul id="main-nav-menu" class="nav-menu">
					<li id="nav-home" class="current" >
						<a href="<?php echo base_url()?>">Hello!</a>
					</li>
					<li id="nav-about" >
